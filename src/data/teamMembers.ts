...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    nameEn: 'Kim Dae-sung',
    role: 'AI Product Manager',
    specialties: ['Logic Design', 'AI Execution'],
    philosophy: 'Think Deep, Move fast, 실험하는 통찰가',
  ...
  },
  {
    ...
    nameEn: 'Park Da-hyo',
    role: 'AI Product Manager',
    specialties: ['AI User-Centric', 'Cross-functional'],
    philosophy: '아이디어를 실행 가능한 기획으로 구체화하는 기획자',
