        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="relative" ref={githubDropdownRef}>
            ...
            >
              ...
              <svg
                className={`w-4 h-4 transition-transform ${isGitHubDropdownOpen ? 'rotate-180' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            {/* 드롭다운 메뉴 */}
            {isGitHubDropdownOpen && (
              <div className="absolute right-0 mt-2 w-56 rounded-lg shadow-lg z-50" style={{ backgroundColor: '#30336b', border: '1px solid rgba(255, 255, 255, 0.1)' }}>
                <div className="py-1">
                  <a
                    href="https://github.com/aileondsk-ai/saju-king"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block px-4 py-3 text-sm text-white hover:opacity-80 transition-opacity"
